...
function parseSaveNewRecipePayload(payload) {
...
function mapUnitToPrismaUnit(unit) {
 ...
 */
app.post("/api/saveNewRecipe", authenticateToken, upload.fields([
    ...
    try {
        ...
        const recipe = await prisma.$transaction(async (tx) => {
            ...
            for (const ingredient of payload.ingredients) {
                ...
                const variationIngredientName = ingredient.variationIngredientName?.trim();
...
export async function saveImageKeyToPrisma() {
    app.post("/api/recipes/:id/image", authenticateToken, upload.single("image"), async (req, res) => {
        try {
