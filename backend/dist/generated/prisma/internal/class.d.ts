 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.ingredientSubstitution`: Exposes CRUD operations for the **IngredientSubstitution** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more IngredientSubstitutions
      * const ingredientSubstitutions = await prisma.ingredientSubstitution.findMany()
      * ```
      */
    get ingredientSubstitution(): Prisma.IngredientSubstitutionDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
